...
export type StorageHash =
  StorageHashBase<'8f8ec1c5c61f8e16f2d99b487a48ff3d00f2ceb57df429c2b9d6859edf8ba8cb'>;
export type ExecutionHash =
  ExecutionHashBase<'e4f63cae1d67e359695a403ecf2bf3ce701d6d9df4a4b1e68ce39281bf8b8b8e'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly HabitLog: {
      ...
      readonly habitId: CodecTypes['pg/int4@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly HabitLog: {
      ...
      readonly habitId: CodecTypes['pg/int4@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/int4@1']['input'];
...
export namespace Models {
  ...
  export type public_Habit = {
    ...
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    logs: public_HabitLog[];
    user: public_User;
    readonly [RelationKeys]?: 'logs' | 'user';
  };
  export type public_HabitLog = {
    id: CodecTypes['pg/int4@1']['output'];
    completed: CodecTypes['pg/bool@1']['output'];
    date: CodecTypes['pg/timestamptz-temporal@1']['output'];
    habitId: CodecTypes['pg/int4@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    habit: public_Habit;
...
export declare const models: {
  public: {
    ...
    HabitLog: Models.public_HabitLog;
  };
};
        ...
        readonly entries: {
          readonly table: {
            readonly habit: {
              ...
              indexes: readonly [
                {
                  readonly name: 'habit_userId_idx_a489d58a';
                  readonly prefix: 'habit_userId_idx';
            ...
            readonly habitLog: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['habitId', 'date'] }];
              indexes: readonly [
                {
                  readonly name: 'habitLog_habitId_idx_5a237ba2';
                  readonly prefix: 'habitLog_habitId_idx';
...
> & {
  ...
  readonly roots: {
    ...
    readonly habitLog: { readonly namespace: 'public' & NamespaceId; readonly model: 'HabitLog' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
